...
```bash
   ...
   unzip data.zip
   ```
If your system does not support wget (likely if you are on macOS):
you can also pull and then unzip the IMC workshop data using:

```bash
curl -L -o data.zip https://zenodo.org/records/19184908/files/data.zip
unzip data.zip
```
