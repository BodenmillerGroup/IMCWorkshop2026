...
In the example below we retain interactions who are significant in more than 
70% of images tag the edges as attraction or repulsion.

We will also customize node and edge aesthetics directly using `plotInteractions`
